        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className={`rounded-2xl border-2 border-white/60 bg-white/90 backdrop-blur-xl p-6 md:p-8 shadow-2xl space-y-6 ${isRTL ? "text-right" : "text-left"}`}>
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">{t("sections.information.title")}</h2>
              <p className="text-muted-foreground leading-relaxed">{t("sections.information.content")}</p>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">{t("sections.collection.title")}</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">{t("sections.sharing.title")}</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">{t("sections.rights.title")}</h2>
